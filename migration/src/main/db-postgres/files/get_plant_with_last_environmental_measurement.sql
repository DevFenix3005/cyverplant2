CREATE
OR REPLACE FUNCTION get_plant_with_last_environmental_measurement(owner_uuid uuid)
...
ORDER BY p0.plant_name DESC LOOP
...
ORDER BY em1.measured_at DESC LIMIT 1;
return
next _current;
end loop;
    return;
